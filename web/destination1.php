    ...
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
      <div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
			 <div class="polaroid1">
			  <div class="img-hover-zoom img-hover-zoom--brightness">
                   <a href="dubai1.php"><img src="images\od1.jpg" alt="5 Terre" style="width:350px;height:250px;"></a>
                    <div class="text2">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
                <div class="polaroid1">
				 <div class="img-hover-zoom img-hover-zoom--brightness">
                    <a href="hongkong1.php"><img src="images\od2.jpg" alt="Norther Lights" style="width:350px;height:250px;"></a>
                     <div class="text2">
                     ...
                     <a href="hongkong1.php"><h4>Starting From Rs. 835310/-</h4></a>
					 </div>
				 </div>
                </div>
             </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
              <div class="polaroid1">
			   <div class="img-hover-zoom img-hover-zoom--brightness">
                 <a href="singapore1.php"><img src="images\od3.jpg" alt="5 Terre" style="width:350px;height:250px;"></a>
                   <div class="text2">
                   ...
                   <a href="singapore1.php"><h4>Starting From  Rs. 660999/-</h4></a>
				   </div>
              </div>
            </div>
			</div>
           <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
              <div class="polaroid1">
			  <div class="img-hover-zoom img-hover-zoom--brightness">
                 <a href="thailand1.php"><img src="images\od4.jpg" alt="Norther Lights" style="width:350px;height:250px;"></a>
                      <div class="text2">
                      ...
                      <a href="thailand1.php"><h4>Starting From Rs.184654/-</h4></a>
					  </div>
              </div>
			  </div>
           </div>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
             <div class="polaroid1">
			  <div class="img-hover-zoom img-hover-zoom--brightness">
                  <a href="bali1.php"><img src="images\od5.jpg" alt="5 Terre" style="width:350px;height:250px;"></a>
                       <div class="text2">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
             <div class="polaroid1">
			  <div class="img-hover-zoom img-hover-zoom--brightness">
                <a href="egypt1.php"><img src="images\od6.jpg" alt="Norther Lights" style="width:350px;height:250px;"></a>
                   <div class="text2">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
              <div class="polaroid1">
			   <div class="img-hover-zoom img-hover-zoom--brightness">
                  <a href="paris1.php"><img src="images\od7.jpg" alt="5 Terre" style="width:350px;height:250px;"></a>
                     <div class="text2">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 service-grid-wthree text-center">
             <div class="polaroid1">
			  <div class="img-hover-zoom img-hover-zoom--brightness">
                <a href="italy1.php"><img src="images\od8.jpg" alt="Norther Lights" style="width:350px;height:250px;"></a>
                   <div class="text2">
             ...
             <div class="polaroid1">
			  <div class="img-hover-zoom img-hover-zoom--brightness">
                  <a href="bali1.php"><img src="images\od9.jpg" alt="5 Terre" style="width:350px;height:250px;"></a>
                       <div class="text2">
                       ...
                       <a href="maldives1.php"><h4>Starting From Rs.246891/-</h4></a>
					   </div>
					   </div>
             </div>
			 </div>
